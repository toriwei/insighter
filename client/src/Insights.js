...
export default function Insights() {
  ...
  return (
    <ThemeProvider theme={theme}>
      ...
      <Typography variant="body2" component="body1">Made by <a href="https://github.com/toriwei" target="_blank" rel="noopener noreferrer" className={classes.a}>Tori</a></Typography>
    </div>
    </div>
